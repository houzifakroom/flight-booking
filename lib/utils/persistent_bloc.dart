...
abstract class BlocEvent<S, B extends PersistentBloc> extends Equatable {
  BlocEvent() : super();
...
abstract class PersistentBloc<S>
    extends HydratedBloc<BlocEvent<S, PersistentBloc>, S> {
  PersistentBloc([this._initialState]) : super(_initialState);
